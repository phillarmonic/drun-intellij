...
object DrunTextAttributes {
    ...
    @JvmField val INTERPOLATION = key("DRUN_INTERPOLATION", DefaultLanguageHighlighterColors.INSTANCE_FIELD)
    @JvmField val VARIABLE = key("DRUN_VARIABLE", DefaultLanguageHighlighterColors.INSTANCE_FIELD)
